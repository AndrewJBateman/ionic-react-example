...
const ViewPlace = ({}) => {
	...
	const MapView = () => (
		<IonContent className="ion-text-center">
			...
			<Map
				defaultCenter={[
					extendedRecord.coordinates.latitude,
					extendedRecord.coordinates.longitude,
				]}
				defaultZoom={13}
		...
		<IonPage className={styles.page} ref={pageRef}>
			<IonHeader>
				<IonToolbar>
					...
					<IonTitle>{record.distance} km away</IonTitle>
				</IonToolbar>
			</IonHeader>
							...
							<IonRow>
								<IonCol size="8">
									<IonCardSubtitle>
										...
										<IonNote>{record.distance} km away</IonNote>
									</IonCardSubtitle>
								</IonCol>
							</IonRow>
						</div>
										...
										<IonItem lines="full">
											<IonLabel className="ion-text-wrap">
												<IonRow className="ion-align-items-center ion-justify-content-between">
													<IonAvatar>
														<img src={review.user.image_url} alt="user review"/>
													</IonAvatar>
													<IonCardSubtitle>{review.user.name}</IonCardSubtitle>

													<IonButton color="primary">
														Full review on Yelp &rarr;
													</IonButton>
												</IonRow>
